...
document.querySelector(".mobileNavbar").classList.toggle('darkModeBody')
document.querySelectorAll("h1, h2, p,.link a,.about .center .center__right a,.cardHardSkills__title h3, .mobileNavbar .logoMobile svg, .mobileNavbar .logoMobile img, #exit-menu").forEach(function(i){
...
document.querySelectorAll(".home__centerText a, .clipImg, .portfolio .center .right a, .about .center .center__right a").forEach(function(i){
